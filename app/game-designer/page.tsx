          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="skill-tag bg-[#232329]/30 backdrop-blur-sm rounded-xl p-4 text-center border border-[#232329] hover:border-[#A970FF]/50 hover:bg-[#A970FF]/5 transition-all duration-300 group"
                >
                  <span className="text-[#F4F4F5] group-hover:text-[#A970FF] transition-colors">{skill}</span>
                </div>
              ))}
            </div>
          </div>
